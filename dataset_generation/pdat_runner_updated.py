...
DATASET_FILE = "/home/aditya/advait/phi3_mini_levels.json"
LLM_MODEL = "phi3:mini"
MAX_ATTEMPTS = 5
...
def process_ground_truth(agent, i, data):
    """
    Generates the ground_truth response for the entry at index 'i' if it's missing.
...
def process_single_task(agent, i, j, data):
    """
    Handles the LLM query logic for a single test case (perturbed_output) with retries.
    """ 
