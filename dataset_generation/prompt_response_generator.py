...
print(torch.cuda.current_device())  # device index (0, 1, ...)
print(torch.cuda.get_device_name(torch.cuda.current_device())) 

json_file = r"/home/p20200470/advait/nlp_dataset.json"
output_file = r"/home/p20200470/advait/pr_dataset_pro.jsonl"

BATCH_SIZE = 64  # Number of prompts processed concurrently
MAX_WORKERS = 32  # Number of threads to use
...
with open(output_file, "a", encoding="utf-8") as f_out:
    ...
    for i in tqdm(range(0, total_pending, BATCH_SIZE), desc="Processing batches", unit="batch"):
        ...
        results = []
        # ThreadPoolExecutor for concurrent prompt processing
